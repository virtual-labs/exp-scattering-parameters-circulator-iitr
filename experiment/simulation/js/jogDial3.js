   ...
   if(text == "Beam Voltage" )
   {
    Swal.fire({
     ...
     width:'480px',
      ...
      text:'Toggle the switch button and note down the value for V3.',     
      icon:'warning',
      });
   }
else if(v3==0){
...
Swal.fire({
 ...
 width:'480px',
  ...
  html:'Click on <b style="color:blue">Calculate</b> button to calculate isolation and coupling factor.',     
  icon:'info',
  })
